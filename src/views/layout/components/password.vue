<template>
  <el-dialog :visible="passwordDialog" :close-on-click-modal="false" :close-on-press-escape="false" title="修改密码" width="520px" top="30vh" @close="closeDialog" @open="openDialog">
    <el-form ref="form" v-loading="loading" :rules="rules" :model="form" label-width="120px" label-suffix="：" @submit.native.prevent>
    ...
    <div slot="footer" class="dialog-footer">
      <el-button v-waves :loading="loadingBiao" icon="el-icon-success" type="primary" @click="createData"> 保存</el-button>
    </div>
  </el-dialog>
</template>
<script>
