<template>
  <el-dialog :visible="dialogVisible" :modal-append-to-body="false" :fullscreen="isphone()" title="请选择头像" width="580px" top="15vh" @close="handleClose" @open="openDialog">
    ...
    <div slot="footer" class="dialog-footer">
      <el-button type="primary" icon="el-icon-success" @click="handleConfirm"> 保存 </el-button>
    </div>
  </el-dialog>
</template>
<script>
